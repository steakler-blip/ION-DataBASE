...
El Excel resultados_BW.xlsx contiene nombres de campos que no pasan la validación que realiza la plataforma BW, lacual valida la consistencia de los datos configurados en el layout vs los datos generados por los SP, revisar que el SP cumpla con lo solicitado en cada campo.

Existe una versión en crudo del Layout y una versión con comentarios, hay que comparar posibles diferencias en la descripción de los campos.

En el Excel del Layout con comentarios, analizar pestaña "LINEA CREDITO", los comentarios del usuario estan entre la columna F y L, e "Y" y "AD".
